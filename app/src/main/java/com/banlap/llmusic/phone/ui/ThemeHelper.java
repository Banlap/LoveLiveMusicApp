package com.banlap.llmusic.phone.ui;
...
//            }
            ...
            if(MusicPlayService.currentMusic != null && (!TextUtils.isEmpty(MusicPlayService.currentMusic.musicImg) || MusicPlayService.currentMusic.musicImgBitmap != null)) {
                Glide.with(context)
                        .setDefaultRequestOptions(requestOptions)
                        .load((!TextUtils.isEmpty(MusicPlayService.currentMusic.musicImg))? MusicPlayService.currentMusic.musicImg : MusicPlayService.currentMusic.musicImgBitmap)
    ...
    public void settingActivityTheme(Context context, int rThemeId, ActivitySettingsBinding vdb) {
        if(rThemeId == R.id.ll_theme_normal) {
            ...
            vdb.llPermission.setBackgroundResource(R.drawable.selector_normal_selected);
            ...
            vdb.tvPermission.setTextColor(context.getResources().getColor(R.color.light_ff));
            ...
            vdb.tvPermission.setTextColor(context.getResources().getColor(R.color.white));
            ...
            vdb.llPermission.setBackgroundResource(R.drawable.shape_button_black_alpha);
            ...
            vdb.tvPermission.setTextColor(context.getResources().getColor(R.color.purple));
            ...
            vdb.tvPermission.setTextColor(context.getResources().getColor(R.color.orange_0b));
